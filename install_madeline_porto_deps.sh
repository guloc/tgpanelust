...
log_message "Удаление старых версий PHP"
apt_noninteractive remove php7.4 php7.4-* php8.0 php8.0-* php8.1 php8.1-* php8.4 php8.4-*
...
a2dismod php7.4 php8.0 php8.1 php8.4
a2enmod php8.3
...
sed -i 's/php7.4/php8.3/g' /etc/nginx/fastpanel2/php_versions.conf
sed -i 's/php8.0/php8.3/g' /etc/nginx/fastpanel2/php_versions.conf
sed -i 's/php8.1/php8.3/g' /etc/nginx/fastpanel2/php_versions.conf
sed -i 's/php8.4/php8.3/g' /etc/nginx/fastpanel2/php_versions.conf
...
log_message "Установленная версия PHP: $INSTALLED_PHP_VERSION"

echo "Установка завершена. PHP версии $INSTALLED_PHP_VERSION установлен с необходимыми расширениями, ioncube loader и ffmpeg. Старые версии PHP удалены."
